...
function DroneTracker({ map, resetKey }) {
  ...
  const throttledUpdateMarkerPosition = useCallback(throttle((position) => {
  ...
  useEffect(() => {
    ...
    console.log("DroneTracker Effect: Map and socket ready. Setting up layers and listener.");
    ...
    return () => {
      ...
      console.log("DroneTracker Cleanup: Removing gps_update listener and layers.");

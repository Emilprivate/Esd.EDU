    ...
    def _do_flight():
        ...
        try:
            ...
            for i, waypoint in enumerate(waypoints):
                ...
                # Rotate to 0 degrees (north) in place
                log_flight("rotate_north", waypoint_num=i+1)
                local_drone(
                    moveTo(lat, lon, altitude, MoveTo_Orientation_mode.HEADING_START, 0.0)
            ...
            if photo_index < len(photo_waypoints):
                ...
                try:
                    ...
                    if boxes and len(boxes) > 0:
                        ...
                        # No detection → use original compression path
                        if Image is not None:
                ...
                print(f"photo: {filename} at {lat},{lon} detected={detected}")
                photo_index += 1
            else:

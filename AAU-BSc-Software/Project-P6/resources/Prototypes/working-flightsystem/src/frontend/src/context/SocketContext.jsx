...
export const SocketProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const onDroneStatus = (status) => {
      console.log('Drone status update:', status);
    ...
    socketInstance.on('drone_status', onDroneStatus);

    return () => {
      socketInstance.off('connect', onConnect);
      socketInstance.off('disconnect', onDisconnect);
      socketInstance.off('error', onError);
      socketInstance.off('drone_status', onDroneStatus);
